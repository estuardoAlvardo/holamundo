 ...
 <div class="row cont-page">
      <div class="col-md-2 col-xs-2 lat-izquierdo">
        ...
        <a href="../apps/calendarm.php" ><img class="img-responsive" src="../img/calendario.png" style="max-width: 50px; max-height: 50px; margin-left: 20px; margin-top: 50px;" />           
          ...
          <a href="../static/apps/misAlumnos.php"><img class="img-responsive" src="../img/alumnos.png" style="max-width: 50px; max-height: 50px; margin-left: 20px; margin-top: 30px;" title="Mis Alumnos"/>           
          </a>
          <h5 style="color: white; margin-left: 20px;" class="text-left" >Mis Alum....</h5>

          <a href="#" data-toggle="modal" data-target="#plataformas"><img class="img-responsive" src="../img/otras.png" style="max-width: 50px; max-height: 50px; margin-left: 65%; margin-top: -50%;" />            
          </a>
          <h5 style="color: white; margin-left: 60%;" class="text-left">Plataformas</h5>
          <a href="../static/apps/reportbullying.php"><img class="img-responsive" src="../img/alert.png" style="max-width:50px; max-height: 50px; margin-left:10px; margin-top: 30px;" title="Bullyng"/>           
          </a><div style="display: inline-block; border: 3px solid white; border-radius: 20rem; color: white; text-align: center; padding: 0.5rem; box-shadow: rgba(0, 0, 0, 0.15) 0px 1px 3px 0px; font-weight: 600; min-width: 4rem; font-size: 2rem; background-color: rgb(54, 171, 203); position: absolute; margin-top: -60px; margin-left: -32px;" >2</div>
          <h5 style="color: white; margin-left: 20px;" class="text-left" >Bullyng</h5>
         ...
         <a href="../static/apps/calendarm.php" ><img class="img-responsive" src="img/calendario.png" style="max-width: 50px; max-height: 50px; margin-left: 20px; margin-top: 50px;" />           
          ...
          <a href="../apps/misAlumnos.php"><img class="img-responsive" src="../img/alumnos.png" style="max-width: 50px; max-height: 50px; margin-left: 20px; margin-top: 30px;" title="Mis Alumnos"/>           
          </a>
          <h5 style="color: white; margin-left: 20px;" class="text-left" >Mis Alum....</h5>
