...
$insertarPrueba = "INSERT INTO actividadprueba(nombrePrueba,numeroPreguntas,tipoPrueba,punteoPrueba,tipoPunteo,idLeccion) VALUES(:nombrePrueba, :numeroPreguntas, :tipoPrueba,:punteoPrueba, :tipoPunteo,:idLeccion)";
...
$insertarPrueba = $dbConn->prepare($insertarPrueba);
        ...
        $insertarPrueba->bindparam(':tipoPrueba', $_POST['tipoCuestionario']);
...
header("location:3rellenarPrueba.php?idCurso=".$_POST['idCurso']."&nombreCurso=".$_POST['nombreCurso']."&idLeccion=".$_POST['idLeccion'].'&nombrePrueba='.$_POST['nombrePrueba']."&nombreGrado=".@$_POST['nombreGrado']."&seccion=".@$_POST['seccion']."&nivel=".@$_POST['nivel']."&grado=".@$_POST['grado']."&portada=".@$_POST['portada']);         
