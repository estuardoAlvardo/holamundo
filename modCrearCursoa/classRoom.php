            ...
            <div class="text-center col-md-11 cajaleccion" id="fondoModal">
              <div class="cajaPortadaData" >
                ...
                <div class="portadaCurso col-md-6" style="height: 370px;">                
                      ...
                      <form action="subiImagen.php" method="post" enctype="multipart/form-data" accept="image-*">
                          ...
                          <input type="submit" class="btn btn-success" value="Subir" style="margin-left:80%; cursor: pointer; display">
                       </form>                
                </div>
              <?php }
                if(!empty($row1['portada'])){ 
               ...
               <div class="portadaCurso col-md-6" style="background-color: #ffffff; ">                
                  ...
                  <form action="subirImagen.php" method="post" enctype="multipart/form-data" accept="image/*">
                    <input  type="file" name="portada" style="opacity:0;  margin-top: 40%; cursor: pointer; width: 100px; height: 100px; position: absolute; margin-left: 100px; display: none" required >
                    <input type="text" name="idDocente" value="<?php echo $_SESSION['idUsuario'];  ?>" style="display: none"> 
                    <input type="text" name="nombreCurso" value="<?php echo $_GET['nombreCurso'];  ?>" style="display: none">
                    <input type="text" name="idCurso" value="<?php echo $_GET['idCurso'];  ?>" style="display: none"><br><br><br><br>
                    <input type="submit" class="btn btn-success" value="Subir" style="margin-left:15%; cursor: pointer; margin-top:240px; position:absolute; display: none;" >
                  </form>                
                </div>
                <?php } }  ?>                
...
<!----- BLOQUEADO POR SER ALUMNO 
      ...
      -->      
        ...
        <?php while($row2=$datosLeccion->fetch(PDO::FETCH_ASSOC)){?>
         <div class="container" id="redireccionDefault" style="margin-top: 240px; margin-bottom: -330px;">
            <div class="leccion col-md-8">
              <div class="text-right"><?php  echo $row2['nombreLeccion']; ?></div>
                <hr style="border: 1px solid rgb(30,48,83);">
                <!--
                <div class="text-right"><button class="btn btn-primary aqui" id="<?php echo $row2['idLeccion']; ?>" onclick="mostrarVentana(this.id)" value="hola">Agregar Actividad o Recurso </button>
                </div>
              -->
          <div>
    ...
    <div id="miVentana"  class="miVentanaCss">
            <div class="row">
            ...
            <div class="row">
              <div class="col-md-11 text-left" style="margin-left: 3%; padding-bottom:5px; ">
                <h5 class="text-center col-md-12">Recursos</h5>
                <form action="recursoMaterialApoyo/1materialApoyo.php" class="col-md-5" name="crearPrueba" method="get">
                  ...
                  <input type="text" name="grado" value="<?php echo @$_GET['grado'];  ?>"  style="display: none;">
                  <input type="text" name="portada" value="<?php echo @$_GET['portada'];  ?>"  style="display: none;">
                  <input type="submit" name="enviar" value="Material de Apooyo (pdf, word, excel otros)" style="margin-bottom: 10px;" class="btn btn-success">
                </form>
                <form action="recursoYoutube/1materialYoutube.php" class="col-md-3" name="crearPrueba" method="get">
                  ...
                  <input type="text" name="grado" value="<?php echo @$_GET['grado'];  ?>"  style="display: none;">
                  <input type="text" name="portada" value="<?php echo @$_GET['portada'];  ?>"  style="display: none;">
                  <input type="submit" name="enviar" value="Videos de Youtube" style="margin-bottom: 10px;" class="btn btn-success">
                </form>
                ...
                <form action="recursoMisVideos/1misVideos.php" class="col-md-3" name="crearPrueba" method="get">
                  ...
                  <input type="text" name="grado" value="<?php echo @$_GET['grado'];  ?>"  style="display: none;">
                  <input type="text" name="portada" value="<?php echo @$_GET['portada'];  ?>"  style="display: none;">
                  <input type="submit" name="enviar" value="Subir mis Videos o Audio" style="margin-bottom: 10px;" class="btn btn-success">
                </form>                        
              </div>
              <div class="row">
                <h5 class="text-center col-md-12">Banco de Recursos</h5>
                <form action="recursoMisVideos/1misVideos.php" class="col-md-3" name="crearPrueba" method="get">
                  <input type="text" name="idCurso" value="<?php echo @$_GET['idCurso'];  ?>" style="display: none;">
                  <input type="text" name="nombreCurso" value="<?php echo @$_GET['nombreCurso'];  ?>"  style="display: none;">
                  <input type="text" name="idLeccion" id="idLeccion" style="display: none;">
                  ...
                  <input type="text" name="grado" value="<?php echo @$_GET['grado'];  ?>"  style="display: none;">
                  <input type="text" name="portada" value="<?php echo @$_GET['portada'];  ?>"  style="display: none;">
                  <input type="submit" name="enviar" value="Banco de Videos" style="margin-bottom: 10px; margin-left: 50px;" class="btn btn-warning">
                </form>
                <form action="bankoHojas/1hojasTrabajo.php" class="col-md-2" name="crearPrueba" method="get">
                  ...
                  <input type="text" name="grado" value="<?php echo @$_GET['grado'];  ?>"  style="display: none;">
                  <input type="text" name="portada" value="<?php echo @$_GET['portada'];  ?>"  style="display: none;">
                  <input type="submit" name="enviar" value="Banco de Hojas de Trabajo" style="margin-bottom: 10px; margin-left: 50px;" class="btn btn-warning">
                </form>
              </div>
            ...
            <button class="btn btn-danger" onclick="ocultarVentana()" style="margin-left:85%; margin-top: 20px;">cerrar</button>
        </div>
          ...
          <div id="crearLeccion"  class="miVentanaCss">
            ...
            <br>            
            <button class="btn btn-danger" onclick="ocultarVentana2()" style="margin-left:85%; margin-top: 50px;">cerrar</button>           
        </div>          
    </div>
