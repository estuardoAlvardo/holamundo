          ...
          <form action="2opcionMultipleCrear.php" method="post"> 
             ...
             <h5 class="text-left col-md-12" style="margin-top: 50px;">Rellene los campos para subri el Material</h5><br>
                ...
                <div class="input-file-container">  
                  ...
                  <label tabindex="0" for="my-file" class="input-file-trigger">Subir video...</label>
                </div>
                <p class="file-return" style="margin-top: -20px; background-color: #39D2B4; color: black; "></p>
                 <br>
                  ...
                  <input type="submit" name="enviar" class="btn btn-success" value="Subir Video" style="cursor:pointer;">
              </form>
